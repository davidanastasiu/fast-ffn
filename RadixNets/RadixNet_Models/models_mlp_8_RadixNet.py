...
class model_bv_masked(nn.Module):
	def __init__(self, masks, precision = 4):
		...
		self.fc7 = qnn.QuantLinear(1024,1024,bias=True,weight_quant_type=QuantType.INT,weight_bit_width=self.weight_precision,bias_quant=Int8Bias)
		self.fc8 = qnn.QuantLinear(1024,1024,bias=True,weight_quant_type=QuantType.INT,weight_bit_width=self.weight_precision,bias_quant=Int8Bias)
		self.fc9 = qnn.QuantLinear(1024,10,bias=True,weight_quant_type=QuantType.INT,weight_bit_width=self.weight_precision,bias_quant=Int8Bias)
		...
		self.act7 = qnn.QuantReLU(quant_type=QuantType.INT, bit_width=self.weight_precision, return_quant_tensor=True)
		self.act8 = qnn.QuantReLU(quant_type=QuantType.INT, bit_width=self.weight_precision, return_quant_tensor=True)
