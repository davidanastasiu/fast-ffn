...
class model_bv_masked(nn.Module):
	def __init__(self, masks, precision = 4):
		...
		self.fc1 = qnn.QuantLinear(self.input_shape, int(1024),bias=True,weight_quant_type=QuantType.INT,weight_bit_width=self.weight_precision,bias_quant=Int32Bias)
		self.fc2 = qnn.QuantLinear(1024,1024,bias=True,weight_quant_type=QuantType.INT,weight_bit_width=self.weight_precision,bias_quant=Int32Bias)
		self.fc3 = qnn.QuantLinear(1024,1024,bias=True,weight_quant_type=QuantType.INT,weight_bit_width=self.weight_precision,bias_quant=Int32Bias)
		self.fc4 = qnn.QuantLinear(1024,1024,bias=True,weight_quant_type=QuantType.INT,weight_bit_width=self.weight_precision,bias_quant=Int32Bias)
		
		self.fc5 = qnn.QuantLinear(1024,10,bias=True,weight_quant_type=QuantType.INT,weight_bit_width=self.weight_precision,bias_quant=Int32Bias)
